...
This is a step by step guide to include ConsCent Plugin in your app. This plugin is developed in Kotlin and supports both Java and Kotlin languages and supports `Api 21 (Android 5.0)` and above.. 
